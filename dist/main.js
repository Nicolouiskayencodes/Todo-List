AACA;EACE,aAAa;EACb,sBAAsB;EACtB,aAAa;EACb,QAAQ;AACV;AACA;EACE,OAAO;AACT","sourcesContent":["/* reset */\n*, *::before, *::after {\n  box-sizing: border-box;\n}\n* {\n  margin: 0;\n}\nbody {\n  line-height: 1.5;\n  -webkit-font-smoothing: antialiased;\n}\nimg, picture, video, canvas, svg {\n  display: block;\n  max-width: 100%;\n}\ninput, button, textarea, select {\n  font: inherit;\n}\np, h1, h2, h3, h4, h5, h6 {\n  overflow-wrap: break-word;\n}\n#root, #__next {\n  isolation: isolate;\n}\n/* my content */\n.complete {\n  width: 1.2em;\n  height: 1.2em;\n  text-align: center;\n  line-height: 1em;\n  font-size: 1em;\n  padding: 0;\n  margin: 2px;\n  border-radius: 50%;\n  border: 1px solid black;\n  color: green;\n  display: block;\n}\n.project-caption,\n.item-title {\n  border-style: none;\n}\n.project-caption{\n  font-size: 20px;\n  font-weight: 800;\n}\n.item-title{\n  font-size: 16px;\n  font-weight: 500;\n}\ntextarea {\n  border-style: none;\n  background-color: beige;\n}\ntextarea:focus {\n  outline-style: none;\n  background-color:rgb(229, 229, 154);\n}\n.project-table{\n  margin: 20px;\n  background: white;\n}\n.item-title{\n  background-color: beige;\n  justify-self: left;\n}\n.item-title::after {\n  content: '   ▲';\n}\n.open-task > .item-title::after {\n  content: '   ▼';\n}\n.task-container {\n  background-color: beige;\n  padding: 20px;\n  margin: 10px;\n  display: grid;\n  grid-template-columns:auto 1fr auto;\n}\n.open {\n  grid-column: 1/4;\n  margin-top: 10px;\n  display: grid;\n  grid-template-columns: 6fr 1fr;\n}\n\n.project-caption {\n  background-color: lightcyan;\n  padding: 10px;\n  border-radius: 20px;\n}\n.active > .project-caption {\n  background-color: aqua;\n}\n\n.open > button {\n  align-self: end;\n  justify-self: end;\n  width: 1.2em;\n  height: 1.2em;\n  text-align: center;\n  line-height: 1em;\n  font-size: 1em;\n  padding: 0;\n  margin: 2px;\n  border-radius: 50%;\n  border: none;\n  color: red;\n  display: block;\n  background-color: inherit;\n  font-weight: 800;\n}\n.open > button:hover {\n  background-color: red;\n  color:black;\n}\n.open p:first-child {\n  color: gray;\n  margin-bottom: 10px;\n}\nform {\n  display: grid;\n  grid-template-columns: auto 1fr;\n  margin: 10px;\n  gap: 5px;\n  width: 500px;\n  border: 1px solid black;\n  padding: 10px;\n  border-radius: 10px;\n  box-shadow: 2px 2px 2px gray;\n}\nlabel {\n  padding: 5px;\n}\n#create-project {\n  margin: 10px;\n  margin-bottom: 0;\n}\n\n#wrap {\n  display: flex;\n}\n#sidebar {\n  display: flex;\n  flex-direction: column;\n  padding: 10px;\n  gap: 5px;\n}\n#content {\n  flex: 1;\n}"],"sourceRoot":""}]);
// Exports
